...
# great lengths to make each task feel like it executes in a simple, linear way. (Just like your operating system
# goes to great lengths to make it feel like your single-threaded code executes in a simple linear way, even though
# under the covers the operating system juggles between different threads and processes in essentially the same way
# Trio does.) But it is useful to have a rough model in your head of how the code you write is actually executed,
...
# internally, then this blog post is a good deep dive, or check out this great walkthrough to see how to build a
# simple async I/O framework from the ground up.

# Trio is the Python I/O library I always wanted; I find it makes building I/O-oriented programs easier,
# less error-prone, and just plain more fun
