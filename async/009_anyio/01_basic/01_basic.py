...
for Trio together with a library written for asyncio.

Tasks spawned by these “native” libraries on backends other than Trio are not subject to the cancellation rules 
enforced by AnyIO
