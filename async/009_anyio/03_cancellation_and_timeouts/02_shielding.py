"""
There are cases where you want to shield your task from cancellation, at least temporarily. The most important such
...
async def main():
    async with create_task_group() as tg:
        with CancelScope(shield=True) as scope:
            ...
            # cancelled. Shielding a cancel scope is often best combined with move_on_after() or fail_after(),
